...
import (
	...
	grpc "github.com/nknab/Moneway/balance/pkg/grpc"
...
var fs = flag.NewFlagSet("balance", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "balance")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterBalanceServer(baseServer, grpcServer)
