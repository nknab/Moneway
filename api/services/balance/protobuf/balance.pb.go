...
// source: balance/protobuf/balance.proto
...
func (*GetBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_29007e3d4103e9cf, []int{0}
}
...
func (*GetBalanceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_29007e3d4103e9cf, []int{1}
}
...
func (*UpdateBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_29007e3d4103e9cf, []int{2}
}
...
func (*UpdateBalanceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_29007e3d4103e9cf, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*GetBalanceReply)(nil), "balance.GetBalanceReply")
	proto.RegisterType((*UpdateBalanceRequest)(nil), "balance.UpdateBalanceRequest")
	proto.RegisterType((*UpdateBalanceReply)(nil), "balance.UpdateBalanceReply")
}

func init() { proto.RegisterFile("balance/protobuf/balance.proto", fileDescriptor_29007e3d4103e9cf) }

var fileDescriptor_29007e3d4103e9cf = []byte{
	// 207 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *balanceClient) UpdateBalance(ctx context.Context, in *UpdateBalanceRequest, opts ...grpc.CallOption) (*UpdateBalanceReply, error) {
	...
	err := c.cc.Invoke(ctx, "/balance.Balance/UpdateBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Balance_UpdateBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/balance.Balance/UpdateBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Balance_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "balance/protobuf/balance.proto",
}
